...
\hypertarget{research-interest-uxfe0f}{%
\section{Research interest 😁️}\label{research-interest-uxfe0f}}
...
\midrule
\textcolor[HTML]{7f7f7f}{R -- Statistica -- SPSS -- Sigmaplot -- QGIS -- Git -- Markdown} & \textcolor[HTML]{7f7f7f}{Heavy metal analyses -- Stable isotopes -- Plasma metabolites analyses} & \textcolor[HTML]{7f7f7f}{Catching and handling wild animals -- Sample collection: extraction blood \& feathers -- Censing populations -- Monitoring breeding success} & \textcolor[HTML]{7f7f7f}{Spanish (Mother tongue) -- English (TOEFL iBT 99) -- German (Basic-A2)}\\
\bottomrule
\end{tabular}
