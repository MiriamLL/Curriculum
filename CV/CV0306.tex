...
\midrule
R -- Statistica -- SPSS -- Sigmaplot -- QGIS -- Git -- Markdown & Heavy metal analyses -- Stable isotopes -- Plasma metabolites analyses & Catching and handling wild animals -- Sample collection: extraction blood & feathers -- Censing populations -- Monitoring breeding success & Spanish (Mother tongue) -- English (TOEFL iBT 99) -- German (Basic-A2)\\
\bottomrule
\end{tabular}
